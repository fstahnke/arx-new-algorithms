...
public class BenchmarkAlgorithmRGR extends BenchmarkAlgorithm {
    ...
    public String[][] execute() throws IOException {
        ...
        // TODO: This works for k-anonymity and l-diversity, only. Implement for
        // t-closeness and d-presence
        if (config.containsCriterion(TCloseness.class)) {
            throw new IllegalArgumentException("T-Closeness is not supported");
        } else if (config.containsCriterion(DPresence.class)) { throw new IllegalArgumentException("D-Presence is not supported"); }
